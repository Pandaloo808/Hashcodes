...
firebase=firebase.FirebaseApplication("https://console.firebase.google.com/project/doc-is-home/database/doc-is-home-default-rtdb/data/~2F", None)
login_window = Tk()
